  ...
  return (
    <div data-testid="form-step-6">
      ...
      <div className="space-y-5">
        ...
        <div className="bg-[#F3F4F6] rounded-xl p-5" data-testid="recap-vehicle">
          <div className="flex items-center gap-2 mb-3">
            <Car className="w-5 h-5 text-[#E84D1C]" />
        ...
        <div className="bg-[#F3F4F6] rounded-xl p-5" data-testid="recap-client">
          <div className="flex items-center gap-2 mb-3">
            <User className="w-5 h-5 text-[#E84D1C]" />
        ...
        <div className="bg-[#F3F4F6] rounded-xl p-5" data-testid="recap-rdv">
          <div className="flex items-center gap-2 mb-3">
            <CalendarDays className="w-5 h-5 text-[#E84D1C]" />
      ...
      <Button
        ...
        disabled={loading}
        className="w-full h-14 mt-8 bg-[#E84D1C] hover:bg-[#D4410F] text-white font-bold text-lg rounded-xl shadow-lg shadow-[#E84D1C]/30 active:scale-95 transition-all"
      >
        {loading ? (
