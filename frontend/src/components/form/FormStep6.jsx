  ...
  if (submitted) {
    return (
      <div data-testid="form-success" className="text-center py-8">
        ...
        <h2 className="font-['Outfit'] text-2xl sm:text-3xl font-bold text-[#1E2A44] mb-3">
          Demande envoyee !
        </h2>
        ...
        <Link to="/">
          <Button
            ...
            className="bg-[#1E2A44] hover:bg-[#2A3A5E] text-white font-bold px-8 py-3 rounded-xl"
          >
            Retour a l'accueil
          </Button>
        </Link>
      ...
      <div className="space-y-5">
        ...
        <div className="bg-[#F3F4F6] rounded-xl p-5" data-testid="recap-vehicle">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-bold text-[#1E2A44]">Vehicule</h3>
          </div>
          ...
          {data.estimation && (
            <div className="mt-3 pt-3 border-t border-gray-200">
              ...
              <span className="font-['Outfit'] text-xl font-black text-[#FF5C00] ml-2">
        ...
        <div className="bg-[#F3F4F6] rounded-xl p-5" data-testid="recap-client">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-bold text-[#1E2A44]">Coordonnees</h3>
          </div>
          <div className="grid grid-cols-2 gap-3 text-sm">
        ...
        <div className="bg-[#F3F4F6] rounded-xl p-5" data-testid="recap-rdv">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-bold text-[#1E2A44]">Rendez-vous</h3>
          </div>
          <div className="grid grid-cols-2 gap-3 text-sm">
